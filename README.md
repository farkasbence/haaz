...
## Screenshots
| Home | Playback | Settings | History |
| --- | --- | --- | --- |
| ![home.png](docs/screenshots/home.png) | ![playback.png](docs/screenshots/playback.png) | ![settings.png](docs/screenshots/settings.png) | ![history.png](docs/screenshots/history.png) |
